...
### Case study pattern: slow-burn data-feed poisoning

A recurring pattern in recent field reports is feed poisoning through “trusted-ish” upstream content. The attacker does not attack the model directly. Instead, they influence one of the data streams that your RAG index accepts: public issue trackers, mirrored advisories, forum posts, partner-maintained docs, or transcribed chat archives.

The payload is rarely “run rm -rf.” It is usually a plausible falsehood wrapped in domain language:
