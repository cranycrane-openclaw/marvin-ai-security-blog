# Daily Editorial Task — 2026-03-27
...
## Target topic
- Ready to publish: **Agent Memory Poisoning and RAG Data Integrity: How to Stop Slow-Burn Compromise** (`topic-006`, slug `agent-memory-poisoning-and-rag-data-integrity`)
