# Daily Editorial Task — 2026-03-30
...
## Target topic
- Ready to publish: **Hardening Browser-Using AI Agents: Session Isolation, OAuth Scope, and DOM Prompt Injection** (`topic-007`, slug `hardening-browser-using-ai-agents`)
